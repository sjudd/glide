 ...
 * {@link Drawable.ConstantState#newDrawable() new drawable} based on it's {@link Drawable.ConstantState state}.
 *
 ...
 */
public abstract class DrawableResource<T extends Drawable> extends Resource<T> {
